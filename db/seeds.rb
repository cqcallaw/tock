...
Invite.create(timestamp: '2015-10-01 00:12:34 UTC', reporter: reporters[0])
Join.create(timestamp: '2015-10-01 00:15:00 UTC', reporter: reporters[0])
Checkin.create(timestamp: '2015-10-01 23:14:00 UTC', reporter: reporters[0])
Checkin.create(timestamp: '2015-10-02 22:00:53 UTC', reporter: reporters[0])
Checkin.create(timestamp: '2015-10-02 23:00:53 UTC', reporter: reporters[0])
Checkin.create(timestamp: '2015-10-03 22:10:00 UTC', reporter: reporters[0])
Reminder.create(timestamp: '2015-10-04 22:10:00 UTC', reporter: reporters[0])
Checkin.create(timestamp: '2015-10-04 22:15:00 UTC', reporter: reporters[0])
Reminder.create(timestamp: '2015-10-04 22:15:00 UTC', reporter: reporters[0])
Alert.create(timestamp: '2015-10-05 05:15:00 UTC', reporter: reporters[0])
Checkin.create(timestamp: '2015-10-04 09:01:24 UTC', reporter: reporters[0])
Optout.create(timestamp: '2015-10-04 09:05:00 UTC', reporter: reporters[0])
Optin.create(timestamp: '2015-10-07 12:00:00 UTC', reporter: reporters[0])
Checkin.create(timestamp: '2015-10-08 11:55:00 UTC', reporter: reporters[0])
Checkin.create(timestamp: '2015-10-09 11:55:00 UTC', reporter: reporters[0])
